...
public final class Log {
	...
	public static String computeClientLogMessage(final Client client, final String logMsg) {
		return "Client " + client.getIdentity() + " (client " + client.getIdentity() % Server.OFFSET_ID_CLIENT
				+ " of server " + client.getIdentity() / Server.OFFSET_ID_CLIENT + ")" + logMsg;
	}
	...
	public static String computeServerLogMessage(final Server server, final String logMsg) {
		return "Server " + server.getIdentity() + logMsg;
	}
}
