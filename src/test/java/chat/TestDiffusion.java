...
public class TestDiffusion extends Scenario {
	...
	public void constructAndRun() throws Exception {
		...
		Function<ChatMsgContent, Boolean> conditionForInterceptingI1OnC0 = msg -> msg.getSender() == 0;
		...
		ClientInterceptors.addAnInterceptor("i1", c0, conditionForInterceptingI1OnC0, conditionForExecutingI1OnC0,
				treatmentI1OnC1);
		...
		sleep(3000);
		System.out.flush();
		Assert.assertEquals(2, c1.getV().getEntry(c0.getIdentity()));
